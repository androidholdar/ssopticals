...
export const customers = pgTable("customers", {
  ...
  mobile: text("mobile"),
  newPowerSph: text("new_power_sph"),
  newPowerCyl: text("new_power_cyl"),
  newPowerAxis: text("new_power_axis"),
  oldPowerSph: text("old_power_sph"),
  oldPowerCyl: text("old_power_cyl"),
  oldPowerAxis: text("old_power_axis"),
  notes: text("notes"),
